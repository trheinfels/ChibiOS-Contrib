PLATFORMSRC_CONTRIB := ${CHIBIOS}/os/hal/ports/common/ARMCMx/nvic.c \
                       ...
                       ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52840/nrf52_isr.c \
                       ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52840/hal_efl_lld.c \
...
PLATFORMINC_CONTRIB := ${CHIBIOS}/os/hal/ports/common/ARMCMx \
                       ...
                       ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/NRF52840/mdk
...
include ${CHIBIOS_CONTRIB}/os/hal/ports/NRF5/LLD/USBv1/driver.mk
